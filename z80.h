...
typedef enum { 
    MODE_SUPERVISED,    // Z80 clock is synthesised by the Teensy software. Teensy traces Z80 instruction execution.
    MODE_UNSUPERVISED,  // Z80 clock is independent from the Teensy, may be generated by internal FTM or external crystal. No tracing.
} z80_mode_t;

extern z80_mode_t z80_mode;
void set_z80_operating_mode(z80_mode mode);
