...
UART0_DATA:    equ 0x01
STACK_INIT:    equ 0x0000 ; stack (grows downwards, runtime movable)

        ; we're copied directly into RAM by the Teensy
        org 0xF800
boot:
...
warmboot:
        ...
        ld iy, input_buffer ; set default input buffer location

        ; put a reset vector in place to jump back into us (Teensy does this too)
...
input_buffer:       ; for execution from RAM the input buffer can follow on immediately
